...
from SKCOM_OLD import QuoteEvents
from SKCOM_OLD import ReplyEvents
...
class QueryUtil:
    ...
    def __init__(self, conf):
        log_path = conf.prop.get("SKCOM_OLD", "LOG_PATH")
        account = conf.prop.get("SKCOM_OLD", "ID")
        password = conf.prop.get("SKCOM_OLD", "PASSWORD")
